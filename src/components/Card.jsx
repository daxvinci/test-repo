...
const Card = ({title,date,location,category,description,image,id}) => {
    return ( 
        <div id={id} className="card-container w-full flex mb-5 p-2 gap-3 justify-between">
                    <div className="date w-[15%] p-1 font-semibold">{date}</div>
                    <div className="card flex gap-3 w-[80%] p-4 justify-between shadow-lg rounded-3xl bg-gray-600 backdrop:blur-xl">
